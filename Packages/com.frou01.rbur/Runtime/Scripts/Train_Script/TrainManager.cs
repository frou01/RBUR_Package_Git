...
namespace frou01.RigidBodyTrain
{
    public class TrainManager : UdonSharpBehaviour
    {
        ...
        [SerializeField] public float maxOverShoot = 0.005f;
        [SerializeField] float maxDeltatime = 0.05f;//120fps-20fpsだと6倍になっちゃうが仕方ない　プチフリ対策
        ...
        private void Update()
        {
            DeltaTime[0] = Mathf.Lerp(DeltaTime[0], Mathf.Min(Time.deltaTime, maxDeltatime), 0.1f);
        }
